...
class KMeansOptimizationJob(HyperparameterOptimizationJob):
    ...
    search_space: Apply = hp.choice('model', [('kmeans', {'k': hp.uniformint('k', 4, 20),
    ...
    def get_clusters(self, parameters: dict, urls_and_vectors: DataFrame) -> DataFrame:
        ...
        model = KMeansJob.get_model(urls_and_vectors, parameters["k"], parameters["distance_measure"])
